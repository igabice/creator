...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('asset/images/logo/7dcplain.png')); ?>">
...
<a href="https://wa.me/message/5KY4XP55YV47A1" class="float" target="_blank">
    ...
    <script src="<?php echo e(asset('asset/js/jquery.dataTables.yadcf.js')); ?>"></script>
    <script src="<?php echo e(asset('asset/js/clipboard.min.js')); ?>"></script>
...
<?php /**PATH /Users/mac/webProjects/creator/resources/views/layouts/main.blade.php ENDPATH**/ ?>