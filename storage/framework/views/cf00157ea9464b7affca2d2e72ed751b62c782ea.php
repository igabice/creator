        ...
        <div class="d-flex logo-back">
            ...
            <div class="navbar-brand-box">
                <a href="<?php echo e(route('home')); ?>" class="logo logo-light">
                    <span class="logo-sm">
                        <h1 class=" "><span style="color: #0d6e4e">LE</span></h1>
                        
                    </span>
                    <span class="logo-lg float-left">
                        <h1 class=" "><span style="color: #0d6e4e">LE</span>GOOL</h1>
            ...
            <ul class="navbar-right d-flex list-inline float-right mb-0">
                ...
                <li class="dropdown notification-list d-none d-md-block">
                    <a class="nav-link dropdown-toggle arrow-none waves-effect" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false" style="color: white" >
                        Welcome, <?php echo e(auth()->user()->name); ?> (<?php echo e(auth()->user()->email); ?>) <span class="mdi mdi-chevron-down"></span>
                    </a>
...
<?php /**PATH /Users/mac/webProjects/legool-app/resources/views/inc/navbar.blade.php ENDPATH**/ ?>