...
<div class="row align-items-center">
    <div class="col-12">
        <div class="table-title">
            <div class="row">
                <div class="col-sm-6">
                    <h2>NEW <b> <?php if(request()->type == 'course'): ?> Course 
                    <?php elseif(request()->type == 'strategy'): ?> Strategy 
                    <?php else: ?> Product <?php endif; ?></b></h2>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/webProjects/creator/resources/views/products/create.blade.php ENDPATH**/ ?>