    ...
    <div class="col-12">
        <div class="table-title">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <a href="/create-product?type=strategy" class="btn btn-primary waves-effect waves-light">
                         Add Strategy
                    </a>
                </div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/affilia1/affiliatedng/resources/views/products/strategy.blade.php ENDPATH**/ ?>